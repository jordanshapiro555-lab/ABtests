(function () {
  ...
  function productionStickyIsVisible(wrapper) {
    if (!wrapper) return false;

    return wrapper.classList.contains('product-add__wrapper--show');
  }
  ...
  function runVariation() {
    ...
    if (!productionStickyIsVisible(wrapper)) {
      realButton.classList.remove(HIDE_REAL_CTA_CLASS);
      hideFakeCtaOnly();
      return;
    }
